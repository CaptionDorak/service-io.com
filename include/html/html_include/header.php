...
<div class="rigth-header">
	<div class="form-login">	
		<?php
			if (!isset($_SESSION)) {
			echo '<button type="submit" name="login-button" id="login-button" onclick="loginPush()">Вход</button>
		    	<button type="submit" name="regin-button" id="regin-button" onclick="regPush()">Регистрация</button>';
		    	echo $_SESSION;
			}
